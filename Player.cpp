...
Player::Player(const Player& rhs)
    : inventory_(rhs.inventory_), // This will use Inventory's copy constructor
      name_(rhs.name_) {
}
/**
...
: inventory_(std::move(rhs.inventory_)), // This will use Inventory's move constructor
...
Player& Player::operator=(const Player& rhs) {
    if (this != &rhs) {
        inventory_ = rhs.inventory_; // This will use Inventory's copy assignment
        name_ = rhs.name_;
    }
    return *this;
}
...
Player& Player::operator=(Player&& rhs) {
    if (this != &rhs) {
        inventory_ = std::move(rhs.inventory_); // This will use Inventory's move assignment
        name_ = std::move(rhs.name_);
    }
    return *this;
}